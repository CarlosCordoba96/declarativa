%Ejercicio 17.
% Sean P1 y P2 dos programas que implementan una misma especificación, es
% decir, pueden considerarse semánticamente equivalentes. Si el programa
...
% (Ayuda: utilizar el operador cputime, que se evalúa al número de
% segundos utilizados por Prolog hasta el momento de su ejecución. Así
...
%Hemos inicializado el acumulador, la lista vacía
inv([],I,I).
